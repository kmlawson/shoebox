...
function mail_it($content, $subject, $email, $recipient) {
   global $attachment_chunk, $zaemail, $zamessage, $zaname, $attachment_name, $attachment_type, $attachment_sent, $bcc;
  ...
  // $ib = "----=_InnerBoundery_001";
   ...
   $message .= "You have received a request for access to the Shoebox. \n\n Message From: $zaname \n Email Address: $zaemail \n\n Message Contents: \n\n $zamessage \n";
   //$message .= $content."\n\n";
   //$message .= "\n--".$ib."--\n";
...
// send it off
mail_it(stripslashes($content), ($subject)?stripslashes($subject):"Shoebox Access Request", $zaemail, $recipient);
...
if ($redirect) {
   header("Location: http://huginn.net/shoebox/thanks2.html");
   exit;
} else {
	header("Location: http://huginn.net/shoebox/thanks2.html");
